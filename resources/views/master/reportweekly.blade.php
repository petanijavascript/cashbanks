...
<div class="page-bar">
    <ul class="page-breadcrumb">
        <li>
            ...
            <a href="{{url('/reportweekly')}}">Report Weekly Setting</a>
        </li> 
    </ul>
</div>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-sharp bold uppercase">Report Weekly Setting</span>
            ...
            <div class="modal-body">     
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <form role="form" id="create_report_weekly_form"> 
                            {{ csrf_field() }}
                            <div class="form-body"> 
                                ...
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="mail_to" placeholder="Enter Director Mail">
                                    <label for="form_control_1">Mail To Director</label> 
                                    <span class="help-block">example : harun@ciputra.com, nanik@ciputra.com</span>
                                </div> 
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="cc" placeholder="Enter Executive Mail">
                                    <label for="form_control_1">CC Executive</label>
                                    <span class="help-block">example : jimmy@ciputra.com</span>
                                </div> 
                            </div>
                            <div class="form-actions noborder">
                                <button type="button" class="btn blue" id="ins_submit">Submit</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">     
                <div class="portlet light bordered">
                    ...
                    <!-- modal form add -->
                    <div class="portlet-body form">
                        <form role="form" id="update_report_weekly_form"> 
                            {{ csrf_field() }}
    ...
    $(function(){
        ...
        grid.init({
            ...
            dataTable: { 
                ...
                "ajax": {
                    "url"   : "{{url('reportweekly/datatable')}}",
                    "type"  : "POST"
                },
                columns: [   
                    {data: 'project_id', name: 'vm_report_weekly.project_id'},
                    {data: 'projectname', name: 'vm_report_weekly.projectname'},   
                    {data: 'mail_to', name: 'vm_report_weekly.mail_to'},  
                    {data: 'cc', name: 'vm_report_weekly.cc'},  
        ...
        $form = $("#create_report_weekly_form"); 
        $(document).on('click','.btn_show', function(){
            var id = $(this).data('id');
            
            $.ajax({
                'url' : "{{url('reportweekly/show')}}",
                'data' : {
                    id : id
                },
        ...
        $("#ins_submit",$form).click(function(){
           $.ajax({
               'url' : "{{url('reportweekly/create')}}",
               'type' : 'POST',
               'data' : $form.serialize(),
        ...
        //update
        $formUpdate = $("#update_report_weekly_form");
        $("#submit",$formUpdate).click(function(){
           $.ajax({
               'url' : "{{url('/reportweekly/edit')}}",
               'type' : 'PUT',
