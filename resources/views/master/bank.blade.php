        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-sharp bold uppercase">Bank</span>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue-chambray">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>List of Bank
                            </div>
                            <div class="tools">
...
<!--                                            <a id="sample_editable_1_new" class="btn blue"  data-toggle="modal" href="{{url('export/excel/bank')}}" >-->
                            ...
                            <table class="table table-striped table-bordered table-hover" id="list_bank">
                            <thead>
                                <tr>  
                                    <th>Bank Name</th>   
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Master Bank</h4>
            </div>
            <div class="modal-body">     
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <form role="form" id="create_bank_form"> 
                            {{ csrf_field() }}
                            <div class="form-body"> 
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="bank_name" id="form_control_1" placeholder="Enter Bank Name">
                                    <label for="form_control_1">Bank Name</label>
                                    <span class="help-block">ex: BCA</span>
                                </div> 
                                <div>
                                    Bank akan ditambahkan ke dalam master data setelah di approve oleh admin, dikarenakan banyak yang menambahkan bank yang sudah ada...
                                </div>
                            </div>
            ...
            <div class="modal-body">     
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            <i class="icon-settings font-red-sunglo"></i>
                            <span class="caption-subject bold uppercase">Edit Bank</span>
                        </div> 
                    </div>
                    <!-- modal form add -->
                    <div class="portlet-body form">
                        <form role="form" id="update_bank_form"> 
                            {{ csrf_field() }}
...
<div id="export_modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{url('export/excel/bank/')}}">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
    ...
    $(function(){
        ...
        grid.init({
            ...
            dataTable: { 
                ...
                "ajax": {
                    "url"   : "{{url('bank/datatable')}}",
                    "type"  : "POST"
                },
                columns: [   
                    {data: 'bank_name', name: 'm_bank.bank_name'},  
        ...
        //delete 
        $('#list_bank').on('click', '.btn_delete', function (e) {  
