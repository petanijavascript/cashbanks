            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue-chambray">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>List of Project
                            </div>
                            <div class="tools">
                    ...
                    <div class="portlet-body form">
                        <form role="form" id="create_project_form"> 
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="pt_name" id="form_control_1" placeholder="Enter PT Name">
                                    <label for="form_control_1">PT Name</label>
                                    <span class="help-block">ex: PT.Ciputra Raya</span>
                                </div> 
                                <div class="form-group form-md-line-input">
...
<div id="export_modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{url('export/excel/project/')}}">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            ...
            dataTable: { 
                ...
                "ajax": {
                 ...
                 columns: [  
                    ...
                    {data: 'pt_name', name: 'm_project.pt_name'}, 
