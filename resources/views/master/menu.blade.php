    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Master Menu</h4>
            </div>
            <div class="modal-body">     
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <form role="form" id="create_menu_form"> 
                            {{ csrf_field() }}
                            <div class="form-body">
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="name" id="form_control_1" placeholder="Enter Menu Name">
                                    <label for="form_control_1">Menu Name</label>
                                    <span class="help-block">ex: Project Menu</span>
                                </div>
                                <div class="form-group form-md-line-input"> 
                                    <select class="form-control" name="parent_menu_id" id="form_control_1">
                                        <option value="">--No Parent--</option>
                                        @foreach($listParentMenu as $menu)
                                            <option value="{{$menu->menu_id}}">{{$menu->name}}</option>
                                        @endforeach
                                    </select>
                                    <label for="form_control_1">Parent Menu</label> 
                                </div>
                                <div class="form-group form-md-line-input">
                                    <input type="numeric" class="form-control" name="child_no" id="form_control_1" placeholder="Enter Child No">
                                    <label for="form_control_1">Child No</label> 
                                </div>
                                <div class="form-group form-md-line-input"> 
                                    <select class="form-control" name="app_id" id="form_control_1">
                                        <option value="0">Master</option>
                                        @foreach($listApplication as $app)
                                            <option value="{{$app->app_id}}">{{$app->name}}</option>
                                        @endforeach
                                    </select>
                                    <label for="form_control_1">Application</label> 
                                </div> 
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="link_to" id="form_control_1" placeholder="Enter Link">
                                    <label for="form_control_1">Link To</label>
                                    <span class="help-block">ex: /menutest</span>
                                </div>
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="icon" id="form_control_1" placeholder="Enter Icon">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">     
                <div class="portlet light bordered">
                    ...
                    <!-- modal form add -->
                    <div class="portlet-body form">
                        <form role="form" id="update_menu_form">
                            {{ csrf_field() }}
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    <input type="number" class="form-control" name="child_no" id="form_control_1" placeholder="Enter Child No">
                                    <label for="form_control_1">Child No</label> 
                                </div>
                                <div class="form-group form-md-line-input"> 
                                    <select class="form-control" name="app_id" id="form_control_1">
    ...
    $(function(){
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url":  "{{url('menu/datatable')}}",
                    "type"  : "POST" 
                },
                 columns: [  
                    {data: 'menu_id', name: 'm_menu.app_id'},
                    {data: 'name', name: 'm_menu.name'}, 
                    {data: 'parent_menu_id', name: 'm_menu.parent_menu_id'},  
                    {data: 'child_no', name: 'm_menu.child_no'},  
                    {data: 'application_name', name: 'm_application.name'},    
                    {data: 'link_to', name: 'm_menu.link_to'}, 
                    {data: 'icon', name: 'm_menu.icon'},  
        ...
        //delete 
        $('#list_menu').on('click', '.btn_delete', function (e) {  
