...
<div id="container"> 
    ...
    <table>
        <tbody>
            ...
            @endif
			@if($total_closing_balance_deposit_doc_dk !=0 || $total_in_deposit_doc_dk != 0 || $total_out_deposit_doc_dk != 0)
                <tr>
                    <td style="white-space:nowrap">Total Saldo Deposito On Call Dana Kebersamaan:</td><td>{{$total_closing_balance_deposit_doc_dk}}</td>
                </tr>
            @endif
            ...
            @endif
            @if($total_closing_balance_reksadana != 0 || $total_in_reksadana != 0 || $total_out_reksadana != 0)
                <tr>
                    <td style="white-space:nowrap">Total Saldo Reksadana :</td><td>{{$total_closing_balance_reksadana}}</td>
                </tr>
            @endif
            @if($total_closing_balance_reksadana_usd !=0 || $total_in_reksadana_usd != 0 || $total_out_reksadana_usd != 0)
                <tr>
                    <td style="white-space:nowrap">Total Saldo Reksadana (USD) :</td><td>${{$total_closing_balance_reksadana_usd}}</td>
                </tr>
            @endif
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            @foreach($list_cashbank as $c) 
                @if($c->currency=='IDR' && ($c->opening_balance != 0 || $c->closing_balance != 0 || $c->in_ !=0 || $c->out_ !=0)&& ($user_email!='fujhi.suryadi@ciputra.com'))
                <tr>
				...
				@if($c->currency=='IDR' && ($c->opening_balance != 0 || $c->closing_balance != 0 || $c->in_ !=0 || $c->out_ !=0)&& ($user_email=='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account}}_gg_{{$c->bank_account_id}}</td>
                    <td>{{number_format($c->opening_balance,0,",",".")}}</td>
                    <td>{{number_format($c->in_,0,",",".")}}</td>
                    <td>{{number_format($c->out_,0,",",".")}}</td>
                    <td>{{number_format($c->closing_balance,0,",",".")}}</td>
    ...
    <table>
        ...
        <tbody>
            @foreach($list_cashbank as $c)  
				@if($c->currency=='USD' && ($c->opening_balance != 0 || $c->closing_balance != 0 || $c->in_ !=0 || $c->out_ !=0)&& ($user_email=='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account_report}}</td>
                    <td>${{number_format($c->opening_balance,0,",",".")}}</td>
                    <td>${{number_format($c->in_,0,",",".")}}</td>
				...
				@if($c->currency=='USD' && ($c->opening_balance != 0 || $c->closing_balance != 0 || $c->in_ !=0 || $c->out_ !=0)&& ($user_email=='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account_report}}__{{$c->bank_account_id}}</td>
                    <td>${{number_format($c->opening_balance,0,",",".")}}</td>
                    <td>${{number_format($c->in_,0,",",".")}}</td>
                    <td>${{number_format($c->out_,0,",",".")}}</td>
                    <td>${{number_format($c->closing_balance,0,",",".")}}</td>
    ...
    <table>
        ...
        <tbody>
            @foreach($list_bank_operational as $c)
				@if($c->currency=='IDR' && ($c->opening_balance != 0 || $c->closing_balance != 0)&& ($user_email!='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account_report}}</td> 
                    <td>{{number_format($c->opening_balance,0,",",".")}}</td>
                    <td>{{number_format($c->in_,0,",",".")}}</td>
    ...
    <table>
        ...
        <tbody> 
            @foreach($list_bank_operational as $c)  
				@if($c->currency=='USD' && ($c->opening_balance != 0 || $c->closing_balance != 0) && ($user_email!='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account_report}}</td> 
                    <td>${{number_format($c->opening_balance,0,",",".")}}</td>
                    <td>${{number_format($c->in_,0,",",".")}}</td>
    ...
    <table>
        ...
        <tbody>
            @foreach($list_bank_operational_jo as $c)
				@if($c->currency=='IDR' && ($user_email!='fujhi.suryadi@ciputra.com'))		
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account_report}}</td> 
                    <td>{{number_format($c->opening_balance,0,",",".")}}</td>
                    <td>{{number_format($c->in_,0,",",".")}}</td>
    ...
    <table>
        ...
        <tbody>
            @foreach($list_bank_dk as $c)  
				@if(($c->opening_balance != 0 || $c->closing_balance != 0) && ($user_email!='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account_report}}</td> 
                    <td>{{number_format($c->opening_balance,0,",",".")}}</td>
                    <td>{{number_format($c->in_,0,",",".")}}</td>
    ...
    <table>
        ...
        <tbody>
            @foreach($list_deposit as $c)  
                @if($c->currency=='IDR' && ($c->deposit_type=="deposit" && ($c->opening_balance != 0 || $c->closing_balance != 0)) && ($user_email!='fujhi.suryadi@ciputra.com'))
                <tr>
   ...
   @if($total_closing_balance_deposit_usd !=0 || $total_in_deposit_usd != 0 || $total_out_deposit_usd != 0)
    ...
    <table>
        ...
        <tbody>
            @foreach($list_deposit as $c) 
                @if($c->currency=='USD' && ($c->deposit_type=="deposit" && ($c->opening_balance != 0 || $c->closing_balance != 0)) && ($user_email!='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account}}</td> 
                    <td>{{$c->percent_deposit}}</td> 
                    <td>${{number_format($c->opening_balance,0,",",".")}}</td>
				...
				@if($c->currency=='USD' && ($c->deposit_type=="deposit" && ($c->opening_balance != 0 || $c->closing_balance != 0)) && ($user_email=='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account}}__{{$c->bank_account_id}}</td> 
                    <td>{{$c->percent_deposit}}</td> 
                    <td>${{number_format($c->opening_balance,0,",",".")}}</td>
                    <td>${{number_format($c->in_,0,",",".")}}</td>
                    <td>${{number_format($c->out_,0,",",".")}}</td>
    ...
    <table>
        ...
        <tbody>
            @foreach($list_deposit_dk as $c)  
				...
				@if($c->currency=='IDR' && ($c->opening_balance != 0 || $c->closing_balance != 0) && ($user_email=='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account}}_{{$c->bank_account_id}}</td> 
                    <td>{{$c->percent_deposit}}</td> 
                    <td>{{number_format($c->opening_balance,0,",",".")}}</td>
                    <td>{{number_format($c->in_,0,",",".")}}</td>
                    <td>{{number_format($c->out_,0,",",".")}}</td>
    ...
    @if($total_closing_balance_deposit_doc_dk !=0 || $total_in_deposit_doc_dk != 0 || $total_out_deposit_doc_dk != 0)
    <hr>
    <p><strong>Deposito On Call DK</strong></p>
    <table>
        <thead>
            <th>Bank Account</th>
            <th>Percent Deposit</th>
        ...
        <tbody>
            @foreach($list_deposit_doc_dk as $c)  
                @if($c->currency=='IDR' && ($c->opening_balance != 0 || $c->closing_balance != 0) && ($user_email!='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account}}</td> 
                    <td>{{$c->percent_deposit}}</td> 
        ...
        <tfooter> 
            <tr>
                <td>Total Saldo</td>
                <td></td>
                <td>{{$total_opening_balance_deposit_doc_dk}} </td>
                <td>{{$total_in_deposit_doc_dk}} </td>
                <td>{{$total_out_deposit_doc_dk}} </td>
                <td>{{$total_closing_balance_deposit_doc_dk}} </td>
            </tr>
        </tfooter>
    </table> 
    @endif
    ...
    @if($total_closing_balance_deposit_doc_dk_usd != 0 || $total_in_deposit_doc_dk_usd !=0 || $total_out_deposit_doc_dk_usd !=0)
    <hr>
    <p><strong>Deposito On Call DK (USD)</strong></p>
    <table>
        <thead>
            <th>Bank Account</th>
            <th>Percent Deposit</th>
        ...
        <tfooter> 
            <tr>
                <td>Total Saldo</td>
                <td></td>
                <td>${{$total_opening_balance_deposit_doc_dk_usd}} </td>
                <td>${{$total_in_deposit_doc_dk_usd}} </td>
                <td>${{$total_out_deposit_doc_dk_usd}} </td>
                <td>${{$total_closing_balance_deposit_doc_dk_usd}} </td>
            </tr>
        </tfooter>
    </table> 
    @endif
    ...
    <table>
        ...
        <tbody>
            @foreach($list_reksadana as $c)  
                @if($c->currency=='IDR' && ($c->opening_balance != 0 || $c->closing_balance != 0) && ($user_email!='fujhi.suryadi@ciputra.com'))
                <tr>
                    <td style="white-space:nowrap">{{$c->bank_account}}</td> 
                    <td>{{$c->percent_reksadana}}</td> 
                    <td>{{number_format($c->opening_balance,0,",",".")}}</td>
                    <td>{{number_format($c->in_,0,",",".")}}</td>
                    <td>{{number_format($c->out_,0,",",".")}}</td>
                    <td>{{number_format($c->closing_balance,0,",",".")}}</td>
        ...
        <tfooter> 
            <tr>
                <td>Total Saldo</td>
                <td></td>
                <td>{{$total_opening_balance_reksadana}} </td>
                <td>{{$total_in_reksadana}} </td>
                <td>{{$total_out_reksadana}} </td>
                <td>{{$total_closing_balance_reksadana}} </td>
            </tr>
        </tfooter>
    </table>
	@endif
    @if($total_closing_balance_reksadana_usd !=0 || $total_in_reksadana_usd != 0 || $total_out_reksadana_usd != 0)
	<hr>
    <p><strong>Reksadana (USD)</strong></p>
    <table>
        <thead>
            <th>Bank Account</th>
            <th>Percent Reksadana</th>
        ...
        <tfooter> 
            <tr>
                <td>Total Saldo</td>
                <td></td>
                <td>{{$total_opening_balance_reksadana_usd}} </td>
                <td>{{$total_in_reksadana_usd}} </td>
                <td>{{$total_out_reksadana_usd}} </td>
                <td>{{$total_closing_balance_reksadana_usd}} </td>
            </tr>
        </tfooter>
    </table>
	@endif
...
@endif
@if($total_closing_balance_reksadana != 0) 
	<p>
	Untuk detail saldo Reksadana, silahkan klik <a href="http://cashbank.ciputragroup.com/cashbank/public/export/excel/reksadana?project={{$project_id}}&year={{$year}}&month={{$month_num}}&start_week={{$start_week}}&end_week={{$end_week}}&reksadana_type=reksadana&type_export=excel">disini</a>.
	</p> 
@endif    
<p>   
Terima kasih,
