...
<body>
 <a class="btn  glyphicon glyphicon-arrow-left" href="{{url('/deposit')}}">&nbspBack</a>
  ...
  <table class="table table-striped">
    <thead>
      <tr>
        ...
        <th style="text-align:right">Percent Deposit</th>
    ...
    <tbody>
        @foreach($transaction as $c)
            ...
            <tr>
                ...
                <td style="text-align:right">{{$c->percent_deposit}}</td>
