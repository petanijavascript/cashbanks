...
<div class="page-bar">
    <ul class="page-breadcrumb">
        <li>
            ...
            <a href="{{url('/bankdk')}}">Bank Dana Kebersamaan</a>
        </li> 
    </ul>
</div>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-sharp bold uppercase">Bank Dana Kebersamaan</span>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue-chambray">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>List of Bank Dana Kebersamaan
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body"> 
                            <div class="table-toolbar">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="list_bankdk">
                                <thead>
                                    <tr>  
                                        <th>Bank Account</th>
                                        <th>Bank Account</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Bank Dana Kebersamaan Transaction</h4>
            </div>
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase">Add Bank Dana Kebersamaan</span>
                        </div> 
                    </div>
                    <!-- modal form add -->
                    <div class="portlet-body form">
                        <form role="form" id="create_bankdk_form"> 
                            {{ csrf_field() }}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
            ...
            <div class="modal-body">     
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            <i class="icon-settings font-red-sunglo"></i>
                            <span class="caption-subject bold uppercase">Edit Bank Dana Kebersamaan</span>
                        </div> 
                    </div>
                    <!-- modal form update -->
                    <div class="portlet-body form">
                        <form role="form" id="update_bankdk_form"> 
                            {{ csrf_field() }}
                            <input type="hidden" name="bank_dk_id">
                            <div class="form-body">
                               <div class="form-group form-md-line-input"> 
...
<div id="export_modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{url('export/excel/bankdk/')}}">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
...
<div id="mail_modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{url('sendmail/bankdk/')}}" id="sendmail_form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn blue btn_send_email" value="submit"/> 
                </div> 
            </form>
			<center>
...
<script>
    ...
    $(function(){
        ...
        $("#set_new_button").on("click", function(){   
            var isEmptyTable = $("#list_bankdk").children("tbody").find("td:first").hasClass('dataTables_empty') ;  
            if(isEmptyTable){ 
                $("#create_modal").modal('show');
            } else{
                $("#set_new_dialog").modal('show');
                $(".act_set_new").on("click", function(){
                    $('#list_bankdk tbody tr').each(function() {
        ...
        var path = "{{url('/autocompleteEmail/bankdk')}}";
        $('.typeahead').typeahead({  
        ...
        $('#view_project_selected,#view_year_selected,#view_month_selected,#view_week_selected').change(function (e) {  
             ...
             var weekSelected      = $("#view_week_selected").val();  
             $.ajax({
                   'url'  : "{{ url('/bankdk/gettotalvalue')}}"+"/"+projectSelectedID+"/"+yearSelected+"/"+monthSelected+"/"+weekSelected,
                   'type' : 'GET',
		...
		@if(count($listProject)>1)
            ...
            $('#view_project_selected').change(function (e) {    
                 var projectSelectedID = $("#view_project_selected").val();  
                 $.ajax({
                       'url'  : "{{ url('/bankdk/listbankaccount') }}" + '/' + projectSelectedID,
                       'type' : 'GET',
        ...
        //delete 
        $('#list_bankdk').on('click', '.btn_delete', function (e) {  
