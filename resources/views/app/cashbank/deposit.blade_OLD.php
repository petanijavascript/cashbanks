                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="start_week" id="week_selected_export">
                                    <?php
                                        for($i=1 ; $i<=5 ; $i++){
                                            echo "<option value=\"$i\" @if($week == $nowWeekNumber) {{selected='selected'}} @endif>$i</option>"; 
                                        }
                                    ?>   
                                </select>
                            </div>
            ...
            dataTable: { 
                ...
                "ajax": {
                 ...
                 columns: [   
                    ...
                    {data: 'deposit_type', name: 'deposit_type',orderable: true},    
                    {data: 'percent_deposit', name: 'percent_deposit',orderable: true},     
                    {data: 'opening_balance', name: 'opening_balance', orderable: true, searchable: false}, 
                    {data: 'in', name: 'in'},  
                    {data: 'out', name: 'out'},  
                    {data: 'closing_balance', name: 'closing_balance', orderable: true, searchable: false},   
