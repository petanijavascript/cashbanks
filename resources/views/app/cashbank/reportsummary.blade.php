...
<div class="page-bar">
    <ul class="page-breadcrumb">
        <li>
            ...
            <a href="{{url('/reportsummary')}}">Report Summary</a>
        </li> 
    </ul>
</div>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-sharp bold uppercase">Deposit</span>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue-chambray">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>List of Deposit
                            </div>
                            <div class="tools">
...
<!--
                                        <div class="btn-group">
                                            <a class="btn blue"  data-toggle="modal" href="#doc_modal">
                                            Add DOC/TC Transaction <i class="fa fa-plus"></i>
                                            </a>
                                        </div>
-->
                                   <!-- <div class="btn-group"> 
							...
							<div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="list_deposit">
                                <thead>
                                    <tr>  
                                        <th>Bank Name</th> 
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Deposit Transaction</h4>
            </div>
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase">Add Deposit</span>
                        </div> 
                    </div>
                    <!-- modal form add -->
                    <div class="portlet-body form">
                        <form role="form" id="create_deposit_form"> 
                            {{ csrf_field() }}
                            <div class="form-body">
                                 <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    @foreach($listBankAccount as $bankAccount) 
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-3">
                                                <div class="form-group form-md-line-input"> 
                                                    <label>
                                                        {{$bank->bank_name}}&nbsp{{$bankAccount->account_no}}</br>({{$bankAccount->deposit_type}})&nbsp({{$bankAccount->currency}})
                                                    </label> 
                                                    ...
                                                    <div class="input-group right-addon"> 
                                                        ...
                                                        @foreach($latestDepositRate as $rate)
                                                            @if($rate->bankAccountID == $bankAccount->bank_account_id)
                                                                ...
                                                                <input type="text" class="form-control create_in" name="percent_deposit_{{$bankAccount->bank_account_id}}"  placeholder="Enter Percent" value="{{$rate->rate}}"> 
                                                            @endif
                                                        @endforeach 
                                                        @if($foundBankAccount == 0)
                                                            <input type="text" class="form-control create_in" name="percent_deposit_{{$bankAccount->bank_account_id}}"  placeholder="Enter Percent"> 
                                                        @endif
...
<!-- end modal -->
<!-- doc modal --> 
<div id="doc_modal" class="modal fade" tabindex="-1">
            ...
            <div class="modal-body">     
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            <i class="icon-settings font-red-sunglo"></i>
                            <span class="caption-subject bold uppercase">Add DOC/TC Transaction</span>
                        </div> 
                    </div>
                    <!-- modal form add -->
                    <div class="portlet-body form">
                        <form role="form" id="create_doc_form"> 
                            {{ csrf_field() }}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group form-md-line-input"> 
                                            <select class="form-control" name="bank_account_id" >
                                                @foreach($listBank as $bank)
                                                    @foreach($listBankAccount as $bankAccount) 
                                                        @if($bank->bank_id === $bankAccount->bank_id)
                                                            <option value="{{$bankAccount->bank_account_id}}">{{$bank->bank_name}}&nbsp&nbsp{{$bankAccount->account_no}}&nbsp
                                                            @if($bankAccount->account_detail != "")
                                                                ({{$bankAccount->account_detail}})
                                                            @endif 
															({{$bankAccount->deposit_type}})&nbsp({{$bankAccount->currency}})
                                                            </option>
                                                        @endif
                                                    @endforeach
                                                @endforeach
                                ...
                                <div class="row">
                                    <div class="col-md-12">  
                                        <div class="form-group form-md-line-input">
                                            <div class="input-group right-addon">
                                                <input type="text" class="form-control" name="percent_deposit"  placeholder="Enter Percent">
                                                <label for="form_control_1">Percent Deposit</label>
                                                <span class="help-block">ex: 5 </span>
                                                <span class="input-group-addon">%</span>
                                            </div> 
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group form-md-line-input">
                                            <input type="text" class="form-control create_in" name="in"  placeholder="Enter In">
                                            <label>In</label>
                                            <span class="help-block">ex: 10000000</span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group form-md-line-input">
                                            <input type="text" class="form-control create_out" name="out"  placeholder="Enter Out">
                                            <label>Out</label>
                                            <span class="help-block">ex: 10000000</span>
                                        </div> 
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group form-md-line-input">
                                            <label class="week_request_label">1</label>
                                            <input type="hidden" class="form-control week_request" name="week" readonly="readonly" value="1"> 
                                            <label>Week</label> 
                                        </div>  
                                    </div>
                                </div> 
            ...
            <div class="modal-body">     
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            <i class="icon-settings font-red-sunglo"></i>
                            <span class="caption-subject bold uppercase">Edit Deposit</span>
                        </div> 
                    </div>
                    <!-- modal form update -->
                    <div class="portlet-body form">
                        <form role="form" id="update_deposit_form"> 
                            {{ csrf_field() }}
                            ...
                            <div class="form-body">
                               <div class="form-group form-md-line-input"> 
                                ...
                                <div class="form-group form-md-line-input"> 
                                    <select class="form-control bank-account-form" name="bank_account_id">
                                         @foreach($listBank as $bank)
                                            @foreach($listBankAccount as $bankAccount)
                                                @if($bank->bank_id === $bankAccount->bank_id)
                                                    <option value="{{$bankAccount->bank_account_id}}">{{$bank->bank_name}}&nbsp{{$bankAccount->account_no}}&nbsp{{$bankAccount->account_detail}}</br>({{$bankAccount->deposit_type}})&nbsp({{$bankAccount->currency}})</option> 
                                                @endif
                                            @endforeach
                                        @endforeach
                                    </select> 
                                ...
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="percent_deposit"  placeholder="Enter Percent Deposit">%
                                    <label for="form_control_1">Percent Deposit</label>
                                    <span class="help-block">ex: 5 </span>
                                </div> 
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control edit_in" name="in"  placeholder="Enter In">
                                    <label for="form_control_1">In</label>
                                    <span class="help-block">ex: 10000000</span>
                                </div>
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control edit_out" name="out"  placeholder="Enter Out">
...
<div id="export_modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{url('export/excel/deposit/')}}">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="start_week" id="week_selected_export">
                                    <?php $week=1; ?>
                                    @foreach($listWeek as $w)
                                     <option value="{{$week}}" @if($week == $nowWeekNumber) {{'selected="selected"'}} @endif>{{$week++}}</option>  
                                    @endforeach 
                                </select>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <h4>Deposit Type</h4>
                                <p>
                                    <select class="col-md-12 form-control" id="type_export" name="deposit_type">
                                        <option value="deposit">Deposito</option>
                                        <option value="deposit_dk">Deposito Dana Kebersamaan</option> 
                                        <option value="deposit_jo">Deposito JO</option> 
                                        <option value="deposit_doc">Deposito On Call</option> 
                                    </select>
                                </p> 
                            </div>
                            <div class="col-md-12">
...
<div id="mail_modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{url('sendmail/deposit/')}}" id="sendmail_form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    ...
                    <div class="scroller" style="height:670px" data-always-visible="1" data-rail-visible1="1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <h4>Mail To:</h4>
                                <p>
                                    <input type="text" class="form-control typeahead" name="mail_to" value="nanik@ciputra.com"/>
                                </p> 
                            </div>
                            <div class="col-md-12">
                                <h4>CC:</h4>
                                <p>
                                    <input type="text" class="form-control typeahead" name="cc" placeholder="abc@abc.com, asd@ads.com"/>
                                </p> 
                            </div>
                            <div class="col-md-12">
                                <h4>Notes:</h4>
    ...
    $(function(){ 
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "ajax": {
                    "url":  "{{url('reportsummary/datatable')}}",
                    "type"  : "POST" ,
                    data: function(d){ 
                 ...
                 columns: [   
					...
					{data: 'Barsa City Yogya', name: 'Barsa City Yogya'}
					{data: 'Bizpark 1 Pulogadung', name: 'Bizpark 1 Pulogadung'},
					{data: 'Bizpark 2 Penggilingan', name: 'Bizpark 2 Penggilingan'},
					{data: 'Bizpark 3 Bekasi', name: 'Bizpark 3 Bekasi'},
					{data: 'Bizpark Bandung', name: 'Bizpark Bandung'},
					{data: 'Bizpark Palembang', name: 'Bizpark Palembang'},
					{data: 'ByPass Ngurah Rai', name: 'ByPass Ngurah Rai'},
					{data: 'Ciputra Golf', name: 'Ciputra Golf'},
					{data: 'Ciputra World Surabaya', name: 'Ciputra World Surabaya'},
					{data: 'Citra Garden Pekanbaru', name: 'Citra Garden Pekanbaru'},
					{data: 'Citra Grand Semarang', name: 'Citra Grand Semarang'},
					{data: 'Citra Harmoni Sidoarjo', name: 'Citra Harmoni Sidoarjo'},
					{data: 'Citra Indah Jonggol', name: 'Citra Indah Jonggol'},
					{data: 'Citra Garden Lampung', name: 'Citra Garden Lampung'},
					{data: 'Citra Garden Sidoarjo', name: 'Citra Garden Sidoarjo'},
					{data: 'Citragran Cibubur', name: 'Citragran Cibubur'},
					{data: 'Citragran Mutiara', name: 'Citragran Mutiara'},
					{data: 'CitraLand Ambon', name: 'CitraLand Ambon'},
					{data: 'CitraLand Cibubur', name: 'CitraLand Cibubur'},
					{data: 'CitraLand City East Jakarta', name: 'CitraLand City EastJakarta'},
					{data: 'CitraLand Denpasar', name: 'CitraLand Denpasar'},
					{data: 'CitraLand Driyorejo', name: 'CitraLand Driyorejo'},
					{data: 'CitraLand Jayapura', name: 'CitraLand Jayapura'},
					{data: 'CitraLand Kedamean', name: 'CitraLand Kedamean'},
					{data: 'CitraLand Kendari', name: 'CitraLand Kendari'},
					{data: 'CitraLand Lampung', name: 'CitraLand Lampung'},
					{data: 'CitraLand Losari Makassar', name: 'CitraLand Losari Makassar'},
					{data: 'CitraLand Manado', name: 'CitraLand Manado'},
					{data: 'CitraLand Palembang', name: 'CitraLand Palembang'},
					{data: 'CitraLand Palu', name: 'CitraLand Palu'},
                    {data: 'UC Makassar', name: 'UC Makassar'}
					// {data: 'CitraLandPekanbaru', name: 'CitraLandPekanbaru'}
					// {data: 'CitraLandPuncakTidar', name: 'CitraLandPuncakTidar'}
					// {data: 'CitraLandSetiabudi', name: 'CitraLandSetiabudi'},
					// {data: 'CitraLandSurabaya', name: 'CitraLandSurabaya'}
					// {data: 'CitraLandTallasaCityMakassar', name: 'CitraLandTallasaCityMakassar'},
					// {data: 'CitraLandUtaraSurabaya', name: 'CitraLandUtaraSurabaya'}
					
                    // {data: 'in', name: 'in', orderable: true}   
//                    {data: 'date_transaction', name: 't_deposit.date_transaction',
...
//                    } 
        ...
        var path = "{{url('/autocompleteEmail/deposit')}}";
        $('.typeahead').typeahead({  
        ...
        $form = $("#create_deposit_form"); 
        $(document).on('click','.btn_show', function(){
            var id = $(this).data('id');
            
            $.ajax({
               'url' : "{{url('deposit/show')}}",
                data : {
                    id : id
                },
        ...
        $formDOC = $("#create_doc_form"); 
        $("#submit",$formDOC).click(function(){
            //clear all formatter
            $('.create_in').each(function(i, obj) { 
                $(this).val($(this).val().replace(/,/g , "")); 
            });
        ...
        //update
        $formUpdate = $("#update_deposit_form");
        ...
        //delete 
        $('#list_deposit').on('click', '.btn_delete', function (e) {  
